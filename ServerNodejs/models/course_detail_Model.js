...
const courses_detail = {
  ...
  lecture: [
    {
      n_chapter: 1,
      chap_name: "Chương 1: Giới thiệu khóa học",
      lessons: [
        {
          lesson_name:
    ...
    {
      n_chapter: 2,
      chap_name: "Chương 2: Phương tiện, cơ sở hoạt động của giao tiếp",
      lessons: [
        {
          lesson_name: "Bài 1: Phương tiện để chuyển tải giao tiếp",
          lesson_time: "08:34",
        },
        {
          lesson_name: "Bài 2: Cơ sở tâm lý của hoạt động giao tiếp",
          lesson_time: "16:57",
        },
        {
          lesson_name: "Bài 3: Cơ sở văn hóa của hoạt động giao tiếp",
          lesson_time: "01:57",
        },
      ],
    },
